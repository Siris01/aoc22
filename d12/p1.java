...
public class p1 {
    ...
    static ArrayList<ArrayList<Pos>> solve() {
        ...
        start.add(new Pos(srcX, srcY));
        visited.add(new Pos(srcX, srcY));
        queue.add(start);
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<Pos>> solutions = solve();
        int ans = 999999999;

        for (int i = 0; i < solutions.size(); i++) {
            if (solutions.get(i).size() < ans) {
                ans = solutions.get(i).size();
            }
        }
